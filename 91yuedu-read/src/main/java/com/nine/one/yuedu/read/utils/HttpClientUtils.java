...
public class HttpClientUtils {
     ...
     * @throws Exception
     */
    public static String sendPostByJson(String url, String body,Map<String,String> headers) throws Exception {
        ...
        try {
            ...
            if (headers!=null&&headers.size()>0){
                Set<String> herdersKey = headers.keySet();
                for (String key : herdersKey) {
     ...
     * @return
     */
    public static String post(String url, Map<String, String> headers, Map<String, Object> jsonMap) {
