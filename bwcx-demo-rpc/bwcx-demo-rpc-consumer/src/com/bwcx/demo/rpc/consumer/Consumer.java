package com.bwcx.demo.rpc.consumer;

import com.bwcx.demo.rpc.api.entity.User;
import com.bwcx.demo.rpc.api.service.UserService;
...
public class Consumer {
    public static void main(String[] args) {
        //1.获取代理类
        UserService userService = (UserService) rpc(UserService.class);
